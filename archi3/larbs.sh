...
# Forked by Emmie Corday <emmie@emmie.moe>
# License: GNU GPLv3
...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/windowsEmmie/voidrice.git" && repobranch="archi3"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/windowsEmmie/LARBS/master/archi3/progs.csv"
